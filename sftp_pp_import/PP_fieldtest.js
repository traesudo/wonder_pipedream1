...
data=[{
        id: 'c8b6ea05-b265-11ec-a3d9-42010aaa001d',
        status: 'draft',
        sort: null,
        user_created: null,
        date_created: null,
        user_updated: null,
        date_updated: '2022-04-07T10:09:41.000Z',
        '#Action_Code': 'A',
        Merchant_Clone_MID: '',
        Merchant_Legal_Name: 'Bindo Labs Limited',
        Merchant_DBA_Name: 'Bindo Labs Limited',
        Merchant_City: 'San Po Kong',
        'Merchant_State/Province': 'HK',
        Merchant_Country_Code: 'HKG',
        Merchant_Zip: '11111',
        Merchant_Phone: '85295678451',
        Merchant_Currency: 'HKD',
        Customer_Service_Phone: '',
        Chargeback_Statement_Email_Address: '',
        Email: '',
        Primary_Phone_Is_SmsCapable: '',
        'Merchant/Corporate_URL': '',
        Alternative_Authorization_Mode: '',
        Alternative_Authorization_Currency_Code: '344',
        TimeZone_ID: '',
        'Merchant_ID_#': '',
        Planet_Payment_MID: '',
        Amex_Mid: '',
        ...
        MCC: '7372',
        Process_Type: '',
        Merchant_Fed_Tax_Id_or_Business_number: '',
        ...
        Role: '',
        Enable_Visa_Debit_Bin_Ranges: '',
        Business_Type: '',
        Sales_ID: '',
        Store_Number: '',
        Auto_Batch_Cutoff_Time: null,
        Visa_Terminal_Capability: null,
        MC_Terminal_Capability: '',
        Product_Types_Supported: '',
        'PYC-MCP_Markup_Method': '',
        'CardTypes-1': '',
        'Currencies-1': '',
        'CardTypes-2': '',
        'Currencies-2': '',
        Merchant_Funding_Bank_Name: '',
        Merchant_Bank_Account_Number_FUNDING: '',
        Funding_Info_Template: '',
        Fee_Info_Template_: '',
        Merchant_Revenue_Sharing_Info_Template: '',
        Acquirer_Revenue_Sharing_Info_Template: '',
        Agent_Bank_Revenue_Sharing_Info_Template: '',
        Gateway_Revenue_Sharing_Info_Template: '',
        Risk_Template: '',
        MasterCard_MID: '111300000001',
        Discover_MID: '',
        Interac_MID: '',
        Maestro_MID: '',
        Visa_MID: '111300000001',
        'Is_Split_Visa/MasterCard_MID': '',
        Merchant_Funding_Account_Type: '',
        Autobatch_Close_Time_Zone_ID: '',
        Mastercard_Assigned_ID: '',
        Allow_Surcharge_on_International_Transactions: '',
        Agent_Bank_Name: '',
        Sales_Agent_Name: '',
        Gateway_Name: '',
        VAR_Name: '',
        ...
        DelayChargebackFunding: '',
        Enable_Funding: '',
        Enable_Fees: '',
        ISO_ID: '',
        Revenue_Frequency: '',
        Revenue_Day_: '',
        Is_Fixed_Revenue_Share: '',
        Revenue_Method: '',
        Fixed_Basis_Points_RevenueShare: '',
        Variable_Percent_Revenue_Share: '',
        Late_Presentment_Fx_Gain_Percent: '',
        Late_Presentment_Fx_Loss_Percent: '',
        Settlement_Fx_Gain_Percent: '',
        Settlement_Fx_Loss_Percent: '',
        Chargeback_Fx_Gain_Percent: '',
        Chargeback_Fx_Loss_Percent: '',
        Representment_FX_Gain_Percent: '',
        Representment_FX_Loss_Percent: '',
        Interchange_Differential_Gain_Percent: '',
        Interchange_Differential_Loss_Percent: '',
        Refund_Markup_Method: '',
        Reserved_for_Future_Development_1: '',
        Ignore_Fx_Gains_And_Losses: '',
        Merchant_Bank_Account_Number_Fees: '',
        Merchant_Bank_Routing_Number_Fees: '',
        Reserved_for_future_development_2: '',
        Reserved_for_future_development_3: '',
        Exception_Check_Period: '',
        Maximum_Txn_Amount: '',
        Max_Transaction_Age: '',
        Hold_Matching_Txns: '',
        Refund_Allowed_Flag: '',
        Projected_Average_Ticket_Amt: '',
        Projected_Sales_Amount: '',
        Projected_Sales_Count: '',
        Projected_Refund_Amount: '',
        Project_Refund_Count: '',
        Refund_To_Sales_Ratio: '',
        Chargeback_Count_Percent: '',
        Chargeback_Amount_percent: '',
        Retrieval_Count_Percent: '',
        Retrieval_Amount_Percent: '',
        Projected_Key_Entered_Percent: '',
        Alerts_Emails: '',
        Reserved_for_future_development_4: '',
        Maximum_Refund_Transaction_Amount: '',
        Fee_Billing_Frequency: '',
        Fee_Billing_Day: '',
        Discount_Fee_Method: '',
        Fee_Currency: '',
        Visa_Discount_Fee_Percent: '',
        MC_Discount_Fee_Percent: '',
        Amex_Discount_Fee_Percent: '',
        Diners_Discount_Fee_Percent: '',
        Discover_Discount_Fee_Percent: '',
        JCB_Discount_Fee_Percent: '',
        CUP_Discount_Fee_Percent: '',
        Interac_Discount_Fee_Percent: '',
        Maestro_Discount_Fee_Percent: '',
        Visa_Per_Item_Transaction_Fee: '',
        Mastercard_Per_Item_Transaction_Fee: '',
        Amex_Per_Item_Transaction_Fee: '',
        Diners_Per_Item_Transaction_Fee: '',
        Discover_Per_Item_Transaction_Fee: '',
        JCB_Per_Item_Transaction_Fee: '',
        Interac_Per_Item_Transaction_Fee: '',
        Maestro_Per_Item_Transaction_Fee: '',
        Debit_Per_item_Transaction_Fee: '',
        Visa_Per_Item_Authorization_Fee: '',
        MC_Per_Item_Authorization_Fee: '',
        Amex_Per_Item_Authorization_Fee: '',
        Diners_Per_item_Authorization_Fee: '',
        Discover_Per_Item_Authorization_Fee: '',
        JCB_Per_Item_Authorization_Fee: '',
        Interac_Per_Item_Authorization_Fee: '',
        Maestro_Per_Item_Authorization_Fee: '',
        Debit_Per_Item_Authorization_Fee: '',
        Authorization_Reversal_Fee: '',
        Authorization_Decline_Fee: '',
        Visa_AVS_Transaction_Fee: '',
        MC_AVS_Transaction_Fee: '',
        AVS_Only_Fee: '',
        Gateway_Per_Item_Fee: '',
        Chargeback_Fee: '',
        Retrieval_Fee: '',
        Batch_Fee: '',
        Web_Fee: '',
        ...
        Gateway_MonthlyFee: '',
        Setup_Fee: '',
        Monthly_Statement_Fee: '',
        Monthly_Fee: '',
        Recurring_Billing_Monthly_Fee: '',
        Virtual_Terminal_Monthly_Fee: '',
        Annual_Fee: '',
        Monthly_Minimum_Fee: '',
        Interchange_Pass_Thru_Indicator: '',
        Visa_Planned_Interchange_Fee_Program_Indicator: '',
        MC_Planned_Interchange_Fee_Program_Indicator: '',
        Visa_Qual_Tier_Id: '',
        MC_Qual_Tier_Id: '',
        Visa_Mid_Qual_Tier_Id: '',
        MC_Mid_Qual_Tier_Id: '',
        Non_Qual_Billing_Method: '',
        Non_Qual_Per_Item_Fee: '',
        Non_Qual_Fee_Percent: '',
        MidQual_Per_Item_Fee: '',
        MidQual_Fee_Percent: '',
        Terminal_Maintenance_Monthly_Fee: '',
        Admin_and_Push_Fund_Monthly_Fee: '',
        Amex_Connectivity_Monthly_Fee: '',
        Wireless_Monthly_Fee: '',
        Food_Voucher_Discount_Rate: '',
        Food_Voucher_Per_Item_Transaction_Fee: '',
        Cirrus_MID: '',
        Visa_ATM_Mid: '',
        Food_Voucher_MID: '',
        Loyalty_Card_MID: '',
        'Transfer_Cash_In/Cash_Out_MID': '',
        Transfer_Mobile_Payment_MID: '',
        'Transfer_Cash_In/Cash_Out_Descount_Fee_Percent': '',
        Transfer_Mobile_Payment_Discount_Fee_Percent: '',
        Food_Voucher_Card_MID_Edenred: '',
        Food_Voucher_Discount_Fee_Percent_Edenred: '',
        Aggregator_Name: '',
        Seller_Account_ID: '',
        PaymentfacilitatorID: '',
        SubMerchantID: '',
        SellerBusinessName: '',
        Reserved_for_future_development_5: '',
        Reserved_for_future_development_6: '',
        Terminal_Id_1: '',
        Terminal_Name_1: '',
        Terminal_Chain_Name_1: '',
        Terminal_Id_2: '',
        Terminal_Name_2: '',
        Terminal_Chain_Name_2: '',
        Terminal_Id_3: '',
        Terminal_Name_3: '',
        Terminal_Chain_Name_3: '',
        Visa_Payment_Facilitator_ID: '',
        Visa_Sub_Merchant_ID: '',
        Visa_ISO_ID: '',
        Product_Profile_Name: '',
        Priority_Checkout_Indicator: null,
        Payment_Profile_Name: '',
        Fee_Profile_Name: '',
        Visa_Terminal_Capability_: '',
        merchant_street_address_address1: null
    },
    {
        id: 'c8b6ea05-b265-11ec-a3d9-42010aaa001d',
        status: 'draft',
...
function generateCSV(data){
    ...
    for(let i=0;i < data.length;i++) {
        ...
        for(var index in usedAPIKeys) {
            ...
            // if(usedAPIKeys[index]=='Merchant_Zip'){
            //     data[i][usedAPIKeys[index]]="852";
            //
            // }
            // if(usedAPIKeys[index]=='Merchant_Phone'){
            //     data[i][usedAPIKeys[index]]="27771177";
            // }
            // if(usedAPIKeys[index]=='Merchant_Currency'){
            //     data[i][usedAPIKeys[index]]="344";
            // }
            // if(usedAPIKeys[index]=='Customer_Service_Phone'){
            //     data[i][usedAPIKeys[index]]="27771177";
            // }
            // //Chargeback Statement Email Address
            // if(usedAPIKeys[index]=='Chargeback_Statement_Email_Address'){
            //     data[i][usedAPIKeys[index]]="account.hk@bindo.com";
            // }
            // if(usedAPIKeys[index]=='Email'){
            //     data[i][usedAPIKeys[index]]="account.hk@bindo.com";
            // }
            // if(usedAPIKeys[index]=='TimeZone_ID'){//
            //     data[i][usedAPIKeys[index]]="43";
            // }
            // if(usedAPIKeys[index]=='Merchant_ID_#'){
            //     //有要求再自动增长++++++++++++++++++++++
            //     // var id=111300300010;
            //     // id.toString()
            //     data[i][usedAPIKeys[index]]='111300300010';

            //
            // }
            // if(usedAPIKeys[index]=='MasterCard_MID'){//特定的判断值 依照Merchant_ID
            //     data[i][usedAPIKeys[index]]='111300300010';
            // }
            // if(usedAPIKeys[index]=='Visa_MID'){
            //     data[i][usedAPIKeys[index]]='111300300010';
            //
            // }
            // if(usedAPIKeys[index]=='Visa_Payment_Facilitator_ID'){
            //     data[i][usedAPIKeys[index]]="10081392";
            // }
            // if(usedAPIKeys[index]=='Visa_Sub_Merchant_ID'){
            //     data[i][usedAPIKeys[index]]=data[i][usedAPIKeys[index]='Merchant_ID'];
            // }
            // if(usedAPIKeys[index]=='Aggregator_Name'){
            //     data[i][usedAPIKeys[index]]='BindoLb';
            // }
            // if(usedAPIKeys[index]=='PaymentfacilitatorID'){
            //     data[i][usedAPIKeys[index]]='265231';
            // }
            // if(usedAPIKeys[index=='SellerBusinessName']){
            //     data[i][usedAPIKeys[index]]='LobsterTechnologies';
            //
            // }
            // if(usedAPIKeys[index=='SubMerchantID']){
            //     data[i][usedAPIKeys[index]]='111300300010';
            //
            // }
            // val.push(data[i][usedAPIKeys[index]]);
            // // val.splice(1,0,"Lobster Technologies Limited") //Room 05-181, 5/F., The Quayside, 77 Hoi Bun Road, Kwun Tong, Kowloon
            // // val.splice(4,1,"Room 05-181, 5/F，The Quayside，77 Hoi Bun Road，Kwun Tong， Kowloon")
            // // val.splice(8,1,"852")
            //


        }
        //val.splice(9,1,"852")//Merchant Zip
        // val.splice(10,1,"27771177")//Merchant Phone
        // // val.push(data[i][usedAPIKeys[2]]="woc")///Merchant Currency
        // val.splice(11,1,"344")//Merchant Currency
        // val.splice(12,1,"27771177")//Customer Service Phone
        // val.splice(13,1,"account.hk@bindo.com")//Chargeback Statement Email Address
        // val.splice(14,1,"account.hk@bindo.com")//Email
        // val.splice(19,1,"43")//TimeZone ID
    ...
    console.log("1111"+selfAdd)
    const remoteFilePath='1';
...
class UploadCompanyInfoTask {
    ...
    generateCSV(data) {
        ...
        console.log(csvContent)
        const remoteFilePath = this.generateRemoteFilePath();
        fs.writeFileSync(remoteFilePath,csvContent);
        //console.log(csvContent)
        console.log(remoteFilePath)
        return remoteFilePath;
    }
    ...
    generateRemoteFilePath() {
        ...
        //return "yy+"-"+mm+"-"+dd.csv";
        var remoteFilePath="/tmp"+"/MerchantBulkLoadV3_Bindo_"+yy+"-"+mm+"-"+dd+".csv"
        return remoteFilePath;
    }
