...
const  llNote1=fs.readFileSync('/Users/developer/id_rsa.txt')
console.log(  llNote1)
console.log( typeof llNote1)

const key=JSON.stringify(llNote1)
...
const client = mysocks.connect({
    ...
    //console.log(conn)
    //
    // conn.put('/Users/developer/id_rsa.txt','/in').then(res => {
    //     console.log(res)
    // }).catch(err => {
    //     console.log(err)
    // })
